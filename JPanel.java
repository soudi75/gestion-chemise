...
JPanel(String nom , String prenom , String matricule, Object fonda, Object option){
initComponents();
nom1=nom;
prenom1=prenom;
...
reinitialiser();
    ...
    int credi1=Integer.parseInt(credit1.getText());
    int credi2=Integer.parseInt(credit2.getText());
    double not=Double.parseDouble(Note3.getText());
    int cred=Integer.parseInt(credit3.getText());
     
    new NewJFrame(not1, not2, credi1, credi2, nom1, prenom1, matricule1, fonda1, option1).setVisible(true);
